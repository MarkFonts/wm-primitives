...
| # | label | repo | rail / context | control | primitive? |
|---|---|---|---|---|---|
...
| 9 | measure | wm-primitives | docs · controls 01–04 | AxisSlider | ✅ |
| 10 | width `wdth` | wm-primitives | docs · controls 01–04 | AxisSlider | ✅ |
| 11 | leading | wm-primitives | docs · controls 01–04 | AxisSlider | ✅ |
| 12 | optical size `opsz` | wm-primitives | docs · controls 01–04 | AxisSlider, `auto` | ✅ |
...
| 19 | measure | font-proofer | proofing controls | AxisSlider `track` | ✅ |
| 20 | size | font-proofer | proofing controls — paragraph | AxisSlider `track` | ✅ |
| 21 | size | font-proofer | proofing controls — words | AxisSlider `track` | ✅ |
| 22 | tracking | font-proofer | proofing controls — paragraph | AxisSlider `track` | ✅ |
| 23 | tracking | font-proofer | proofing controls — words | AxisSlider `track` | ✅ |
| 24 | leading | font-proofer | proofing controls — paragraph | AxisSlider `track` | ✅ |
| 25 | leading | font-proofer | proofing controls — words | AxisSlider `track` | ✅ |
| 26 | Optical Size | font-proofer | axis rail (from `fvar`) | AxisSlider `track` | ✅ |
...
| 32 | opsz | ReCal | preview bar | AxisSlider 01, `allowAuto` | ✅ † |
...
| 39 | Optical size | ReCal | Type Matrix pins | AxisSlider `diamond` | ✅ |
...
| 43 | size | ReCal | typography panel | AxisSlider `track` | ✅ |
| 44 | tracking | ReCal | typography panel | AxisSlider `track` | ✅ |
| 45 | leading | ReCal | typography panel | AxisSlider `track` | ✅ |
| 46 | measure | ReCal | typography panel | AxisSlider `track` | ✅ |
...
| 50 | Size | ReCal | compare / landing rail | bare `<input type=range>` + `.pm-label` | ❌ |
| 51 | Spacing | ReCal | compare / landing rail | bare `<input type=range>` | ❌ |
| 52 | Optical Size | ReCal | compare / landing rail | bare `<input type=range>` | ❌ |
...
| 58 | display size | opsz-proofer | header rail | hand-emitted `.slider-row` HTML | ❌ ‡ |
