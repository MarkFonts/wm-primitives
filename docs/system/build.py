...
SECTIONS = [
    ...
    # 06. Ramps sits beside colour rather than inside it: 05 is an audit of every literal,
    # and a curve is not a literal. Generated by scripts/build-ramps.mjs from the engine,
    # because the values changed three times on the day it was written.
    ("ramps",   "Ramps",        SD/"ramps.html",            "one curve, three channels"),
